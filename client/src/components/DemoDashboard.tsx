  ...
  return (
    <main className="flex-1 overflow-y-auto bg-gray-50 p-6">
      ...
      <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
        <div className="flex">
          <AlertTriangle className="text-amber-500 w-5 h-5 mt-0.5 mr-3 flex-shrink-0" />
          <div>
            <h3 className="text-sm font-medium text-amber-900">Mode Démonstration</h3>
            <p className="text-sm text-amber-700 mt-1">
              Vous visualisez LAPGEST-PRO 2.0 avec des données de démonstration. Pour l'authentification complète, 
              utilisez une fenêtre de navigation privée et cliquez sur "Commencer Maintenant" sur la page d'accueil.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Welcome Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Bienvenue dans LAPGEST-PRO 2.0 !</h2>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{mockMetrics.totalLapins}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{mockMetrics.activeBreeders}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{mockMetrics.expectedBirths}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{mockMetrics.readyToSell}</p>
                <p className="text-sm text-green-600 mt-1">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                ...
                <span className="text-lg font-bold text-green-900">
                  {mockMetrics.monthlyRevenue.toLocaleString('fr-FR')}€
                </span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                ...
                <span className="text-lg font-bold text-red-900">
                  {mockMetrics.monthlyExpenses.toLocaleString('fr-FR')}€
                </span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border-2 border-blue-200">
                ...
                <span className="text-xl font-bold text-blue-900">
                  {mockMetrics.netProfit.toLocaleString('fr-FR')}€
                </span>
              </div>
              ...
              <div className="pt-2 border-t border-gray-200">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-gray-900">
                    {mockMetrics.availableCash.toLocaleString('fr-FR')}€
                  </span>
                </div>
              </div>
            </div>
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            <button className="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-red-50 hover:border-red-300 transition-colors group">
              ...
              <span className="text-sm font-medium text-gray-700 group-hover:text-red-700">Traitement</span>
            </button>
            ...
            <button className="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-purple-50 hover:border-purple-300 transition-colors group">
              <Baby className="w-8 h-8 text-purple-600 group-hover:text-purple-700 mb-2" />
              <span className="text-sm font-medium text-gray-700 group-hover:text-purple-700">Mise Bas</span>
            </button>
          </div>
        </CardContent>
      </Card>
