    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Analyses détaillées de votre ferme cuniculture</p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Graphique d'évolution à venir</p>
                <p className="text-sm text-gray-500 mt-2">
                  CA, bénéfices, coûts sur 12 mois glissants
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Calendrier reproduction à venir</p>
                <p className="text-sm text-gray-500 mt-2">
                  Saillies planifiées, mises bas prévues, sevrages programmés
                </p>
              </div>
            </CardContent>
          </Card>
